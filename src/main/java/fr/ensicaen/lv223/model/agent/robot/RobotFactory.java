    ...
    public Robot createRobot(RobotType type, ProjectTeam team){
        switch (type) {
            case CARTOGRAPHER -> {
                ...
                return new CartographerCopilot(RobotType.CARTOGRAPHER, factory, PlanetInterface.getInstance(planet, robotMapper), CentralizerCopilot.getInstance(RobotType.CENTRALIZER, factory, PlanetInterface.getInstance(planet, robotMapper)), idCartographer++);
            }
            case FOOD_RETRIEVER -> {
                if (team == ProjectTeam.JAMES_BOND)
                ...
                return new FoodRetrieverCopilot(RobotType.FOOD_RETRIEVER, factory, PlanetInterface.getInstance(planet, robotMapper), CentralizerCopilot.getInstance(RobotType.CENTRALIZER, factory, PlanetInterface.getInstance(planet, robotMapper)));
            }
            case FARMER -> {
                if (team == ProjectTeam.JAMES_BOND)
                ...
                return new FarmerCopilot(RobotType.FARMER, factory, PlanetInterface.getInstance(planet, robotMapper), CentralizerCopilot.getInstance(RobotType.CENTRALIZER, factory, PlanetInterface.getInstance(planet, robotMapper)));
            }
            case PIPELINE_BUILDER -> {
                ...
                return new PipelineBuilderCopilot(RobotType.PIPELINE_BUILDER, factory, PlanetInterface.getInstance(planet, robotMapper), CentralizerCopilot.getInstance(RobotType.CENTRALIZER, factory, PlanetInterface.getInstance(planet, robotMapper)));
            }
            case ORE_EXTRACTOR -> {
                if (team == ProjectTeam.JAMES_BOND)
                ...
                return new OreExtractorCopilot(RobotType.ORE_EXTRACTOR, factory, PlanetInterface.getInstance(planet, robotMapper), CentralizerCopilot.getInstance(RobotType.CENTRALIZER, factory, PlanetInterface.getInstance(planet, robotMapper)));
            }
            case CENTRALIZER -> {
                if (team == ProjectTeam.JAMES_BOND)
                ...
                return CentralizerCopilot.getInstance(RobotType.CENTRALIZER, factory, PlanetInterface.getInstance(planet, robotMapper));
            }
